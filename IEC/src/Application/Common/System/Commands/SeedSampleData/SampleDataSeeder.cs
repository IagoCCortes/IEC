    ...
    public class SampleDataSeeder
    {
        ...
        private async Task SeedMoviesAsync(CancellationToken cancellationToken)
        {
            var movies = new[]
            {
                ...
                new Movie { Id = 12, Title = "300", PosterUrl = "https://m.media-amazon.com/images/M/MV5BMjc4OTc0ODgwNV5BMl5BanBnXkFtZTcwNjM1ODE0MQ@@._V1_SY1000_SX675_AL_.jpg", Runtime = 117, ReleaseDate = DateTime.Parse("2007-03-09"), Plot = "King Leonidas of Sparta and a force of 300 men fight the Persians at Thermopylae in 480 B.C."}
            };
